...
[**How it works**](docs/how-it-works.md) — the same product explained at the level of the
code: the three tiers git reconciles in, what a check may and may not be, how evidence is
anchored and expired, and the incidents behind each rule.
